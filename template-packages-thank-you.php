<?php
/**
 * Template Name: Packages Thank You
 *
...
<div class="container <?php if($top_page_margin != "No") { echo 'marT60'; } ?> <?php if($bottom_page_margin != "No") { echo 'padB60'; } ?>">
    ...
    <article class="col span_12">
    	...
    	<div class="packages-container">
	    	...
	    	<div class="packages-tab marB40">
				<div class="tablinks">
				  <div><?php _e('Select a Package', 'contempo'); ?></div>  
				  <div class="tablinks-bar"></div>
				</div>
				<div class="tablinks">
				  <div><?php _e('Payment', 'contempo'); ?></div>
				  <div class="tablinks-bar"></div>
				</div>  
				<div class="tablinks active" onclick="openCity(event, 'Done')">
				  <div><?php _e('Complete', 'contempo'); ?></div>
				  <div class="tablinks-bar"></div>
				</div>
			</div>
