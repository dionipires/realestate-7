    			...
    			<form action="" id="primaryPostForm" class="front-end-form" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="col span_10 first form-section">
                        ...
                        <div class="col span_4 marT15">
                            ...
                            <input type="text" name="iptu" id="iptu" placeholder="<?php esc_html_e(' (exe. 7500 se não houver digite 0)', 'contempo'); ?>" value="" <?php if($ct_front_submit_iptu == 'required') { echo 'required'; } ?> />
                        </div> -->
                    ...
                    <div class="col span_12 first fieldset-buttons">
                        ...
                        <div class="col span_4">
                            <div class="col span_6 first">
                                <a name="next" onclick="Onnextload();" class="next btn right" data-tooltip="<?php _e('Next', 'contempo'); ?>"><i class="fa fa-chevron-right"></i></a>
