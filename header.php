...
echo '<div class="container main">';
    ...
    <!-- Wrapper -->
    <div id="wrapper" <?php if($ct_boxed == "boxed") { echo 'class="boxed"'; } ?>
        <?php if($ct_mode == "single-listing") { echo 'class ="single-listing-layout"'; } ?>>
            ...
            <div class="container">
                ...
                <div class="top-links right">
                    ...
                    <ul class="social left">
                        <?php if($facebook != '') { ?>
                        <li class="facebook"><a href="<?php echo esc_url($facebook); ?>"
                                <?php if($ct_social_new_tab == 'yes') { echo 'target="_blank"'; } ?>><i
                                    class="fa fa-facebook"></i></a></li>
                        <?php } ?>
                        <?php if($twitter != '') { ?>
                        <li class="twitter"><a href="<?php echo esc_url($twitter); ?>"
                                <?php if($ct_social_new_tab == 'yes') { echo 'target="_blank"'; } ?>><i
                                    class="fa fa-twitter"></i></a></li>
                        <?php } ?>
                        <?php if($linkedin != '') { ?>
                        <li class="linkedin"><a href="<?php echo esc_url($linkedin); ?>"
                                <?php if($ct_social_new_tab == 'yes') { echo 'target="_blank"'; } ?>><i
                                    class="fa fa-linkedin"></i></a></li>
                        <?php } ?>
                        <?php if($youtube != '') { ?>
                        <li class="youtube"><a href="<?php echo esc_url($youtube); ?>"
                                <?php if($ct_social_new_tab == 'yes') { echo 'target="_blank"'; } ?>><i
                                    class="fa fa-youtube-square"></i></a></li>
                        <?php } ?>
                        <?php if($pinterest != '') { ?>
                        <li class="pinterest"><a href="<?php echo esc_url($pinterest); ?>"
                                <?php if($ct_social_new_tab == 'yes') { echo 'target="_blank"'; } ?>><i
                                    class="fa fa-pinterest"></i></a></li>
                        <?php } ?>
                        <?php if($instagram != '') { ?>
                        <li class="instagram"><a href="<?php echo esc_url($instagram); ?>"
                                <?php if($ct_social_new_tab == 'yes') { echo 'target="_blank"'; } ?>><i
                                    class="fa fa-instagram"></i></a></li>
                        <?php } ?>
                        <?php if($vk != '') { ?>
                        <li class="vk"><a href="<?php echo esc_url($vk); ?>"
                                <?php if($ct_social_new_tab == 'yes') { echo 'target="_blank"'; } ?>><i
                                    class="fa fa-vk"></i></a></li>
                        <?php } ?>
                        <?php if($contact != '') { ?>
                        <li class="contact"><a href="<?php echo esc_url($contact); ?>"><i
                    ...
                    <ul class="user-frontend left">
                        ...
                        <li class="user-logged-in">
                            <a href="#">
                                <span
                                    class="user-name"><?php esc_html_e('Hi, ','contempo'); ?><?php echo esc_html($current_user->user_firstname); ?></span>
                                <figure>
                                    <?php if($current_user->ct_profile_url) { ?>
                                    <img class="author-img" src="<?php echo esc_html($current_user->ct_profile_url); ?>"
                                        rel="<?php echo esc_html($current_user->user_firstname); ?>" />
                                    <?php } else { ?>
                            ...
                            <ul class="user-drop">
                                ...
                                <li class="membership"><a
                                        <?php if(is_page($ct_user_dashboard)) { echo 'class="current"'; } ?>
                                        href="<?php echo get_page_link($ct_user_dashboard); ?>"><i
                                            class="fa fa-dashboard"></i>
                                        <?php esc_html_e('Dashboard', 'contempo'); ?></a></li>
                                <?php } ?>
                                <?php } ?>
                                <?php if($ct_saved_listings != '' && function_exists('wpfp_link')) { ?>
                                <li class="saved-listings"><a href="<?php echo get_page_link($ct_saved_listings); ?>"><i
                                            class="fa fa-heart"></i>
                                        <?php esc_html_e('Favorite Listings', 'contempo'); ?></a></li>
                                <?php } ?>
                                <?php if($ct_listing_email_alerts_page_id != '' && function_exists('ctea_show_alert_creation')) { ?>
                                <li class="listing-email-alerts"><a
                                        href="<?php echo get_page_link($ct_listing_email_alerts_page_id); ?>"><i
                                            class="fa fa-exclamation-circle"></i>
                                        <?php _e('Saved Searches', 'contempo'); ?></a></li>
                                <?php } ?>
                                <?php do_action('middle_user_dropdown_menu'); ?>
                                <?php if(in_array('administrator', (array) $current_user->roles) || in_array('editor', (array) $current_user->roles) || in_array('author', (array) $current_user->roles) || in_array('contributor', (array) $current_user->roles) || in_array('seller', (array) $current_user->roles) || in_array('agent', (array) $current_user->roles) || in_array('broker', (array) $current_user->roles)) { ?>
                                <?php if(!empty($ct_submit_listing) && $ct_options['ct_enable_front_end'] == 'yes') { ?>
                                <li class="submit-listing"><a href="<?php echo get_page_link($ct_submit_listing); ?>"><i
                                            class="fa fa-plus"></i>
                                        <?php esc_html_e('Submit Listing', 'contempo'); ?></a></li>
                                <?php } ?>
                                <?php if(!empty($ct_view_listings) && $ct_options['ct_enable_front_end'] == 'yes') { ?>
                                <li class="my-listings"><a href="<?php echo get_page_link($ct_view_listings); ?>"><i
                                            class="fa fa-th-list"></i> <?php esc_html_e('My Listings', 'contempo'); ?>
                                        (<?php echo esc_html($ct_user_listings); ?>)</a></li>
                                <?php } ?>
                                <?php if(!empty($ct_membership) && function_exists('ct_create_packages')) { ?>
                                <li class="membership"><a href="<?php echo get_page_link($ct_membership); ?>"><i
                                            class="fa fa-id-badge"></i>
                                        <?php esc_html_e('Membership', 'contempo'); ?></a></li>
                                <?php } ?>
                                <?php if(!empty($ct_invoices) && function_exists('ct_create_packages')) { ?>
                                <li class="invoices"><a href="<?php echo get_page_link($ct_invoices); ?>"><i
                                            class="fa fa-file-text-o"></i>
                                        <?php esc_html_e('Invoices', 'contempo'); ?></a></li>
                                <?php } ?>
                                <?php if(shortcode_exists('ct_listing_analytics') && !empty($ct_listing_analytics)) { ?>
                                <li class="listing-analytics"><a
                                        <?php if(is_page($ct_listing_analytics)) { echo 'class="current"'; } ?>
                                        href="<?php echo get_page_link($ct_listing_analytics); ?>"><i
                                            class="fa fa-line-chart"></i>
                                        <?php esc_html_e('Listing Analytics', 'contempo'); ?></a></li>
                                <?php } ?>
                                <?php } ?>

                                <?php if(!empty($ct_user_profile)) { ?>
                                <li class="my-account"><a href="<?php echo get_page_link($ct_user_profile); ?>"><i
                                            class="fa fa-user"></i>
                                        <?php esc_html_e('Account Settings', 'contempo'); ?></a></li>
                                <?php } ?>
                                <?php do_action('last_user_dropdown_menu'); ?>
                                <li class="logout"><a href="<?php echo wp_logout_url( home_url() ); ?>"><i
                                            class="fa fa-sign-out"></i> <?php esc_html_e('Logout', 'contempo'); ?></a>
                                </li>
                            </ul>
                        </li>
                        <?php } else { ?>
                        <li class="login-register"><a href="#"><i class="fa fa-sign-in"></i>
                                <?php if($ct_enable_front_end_registration != 'no') { esc_html_e('Login / Register', 'contempo'); } else { esc_html_e('Login', 'contempo'); } ?></a>
                        </li>
                        <?php } ?>
                    </ul>
                    <?php } ?>
        ...
        <header class="single-listing-header">
            <div class="container">
                ...
                <div class="single-listing-logo">
                    ...
                    <a href="<?php echo home_url(); ?>"><img class="logo left" src="<?php echo esc_url($ct_logo); ?>"
                            <?php if(!empty($ct_logo_highres)) { ?>srcset="<?php echo esc_url($ct_logo_highres); ?> 2x"
                            <?php } ?> alt="<?php bloginfo('name'); ?>" /></a>
                    <?php } else { ?>
                    <a href="<?php echo home_url(); ?>">
                        ...
                        <?php } else { ?>
                        <img class="logo left" src="<?php echo get_template_directory_uri(); ?>/images/re7-logo.png"
        ...
        <!-- Header -->
        <div id="header-wrap"
            class="<?php echo 'header-style-' . $ct_header_style; ?><?php if($ct_trans_header == 'yes' && is_front_page() && strpos($url,'search-listings=true') != true) { echo ' trans-header'; } ?>">
            <div class="container">
                <header id="masthead" class="layout-<?php echo esc_html($header_layout); ?>">
                    ...
                    <div class="col span_12 first">
                        ...
                        <div class="logo-wrap col span_3 first">
                            ...
                            <a href="<?php echo home_url(); ?>">
                                <?php if(!empty($ct_options['ct_logo']['url'])) { ?>
                                <img class="logo left" src="<?php echo esc_url($ct_options['ct_logo_trans']['url']); ?>"
                                    <?php if(!empty($ct_logo_highres_trans)) { ?>srcset="<?php echo esc_url($ct_logo_highres_trans); ?> 2x"
                                    <?php } ?> alt="<?php bloginfo('name'); ?>" />
                                <?php } else { ?>
                                <img class="logo left"
        ...
        <!-- Header -->
        <div id="header-wrap"
            class="<?php echo 'header-style-' . $ct_header_style; ?><?php if($ct_trans_header == 'yes' && is_front_page() && strpos($url,'search-listings=true') != true) { echo ' trans-header'; } ?> <?php if(!is_user_logged_in()) { echo 'not-logged-in'; } ?>">
            <div class="container">
                <header id="masthead" class="layout-<?php echo esc_html($header_layout); ?>">
                    <?php do_action('inner_header'); ?>
                            ...
                            <ul class="user-frontend right <?php if(!is_user_logged_in()) { echo 'not-logged-in'; } ?>">
                                ...
                                <li class="user-logged-in">
                                    <a href="#">
                                        ...
                                        <figure>
                                            ...
                                            <img class="author-img"
                                                src="<?php echo esc_html($current_user->ct_profile_url); ?>"
                                                rel="<?php echo esc_html($current_user->user_firstname); ?>" />
                                            <?php } else { ?>
                                            <img class="author-img"
                                                src="<?php echo get_template_directory_uri(); ?>/images/blank-user.png" />
                                            <?php } ?>
                                        </figure>
                                        <?php
										                	$ct_user_listings = ct_listing_post_count($current_user->ID, 'listings');
                                    ...
                                    <ul class="user-drop">
                                        ...
                                        <?php if(in_array('administrator', (array) $current_user->roles) || in_array('editor', (array) $current_user->roles) || in_array('author', (array) $current_user->roles) || in_array('contributor', (array) $current_user->roles) || in_array('seller', (array) $current_user->roles) || in_array('agent', (array) $current_user->roles) || in_array('broker', (array) $current_user->roles)) { ?>
                                        <?php if(!empty($ct_submit_listing) && $ct_options['ct_enable_front_end'] == 'yes') { ?>
                                        <li class="submit-listing"><a
                                                href="<?php echo get_page_link($ct_submit_listing); ?>"><i
                                                    class="fa fa-plus"></i>
                                                <?php esc_html_e('Submit Listing', 'contempo'); ?></a></li>
                                        <?php } ?>
                                        <?php if(!empty($ct_view_listings) && $ct_options['ct_enable_front_end'] == 'yes') { ?>
                                        <li class="my-listings"><a
                                                href="<?php echo get_page_link($ct_view_listings); ?>"><i
                                                    class="fa fa-th-list"></i>
                                                <?php esc_html_e('My Listings', 'contempo'); ?>
                                                (<?php echo esc_html($ct_user_listings); ?>)</a></li>
                                        <?php } ?>
                                        <?php if(!empty($ct_membership) && function_exists('ct_create_packages')) { ?>
                                        <li class="membership"><a href="<?php echo get_page_link($ct_membership); ?>"><i
                                        ...
                                        <li class="logout"><a href="<?php echo wp_logout_url( home_url() ); ?>"><i
                                                ...
                                                <?php esc_html_e('Logout', 'contempo'); ?></a></li>
                                    </ul>
                                </li>
                                <?php } else { 
                                ...
                                <li class="login-register"><a
                                        href="#"><?php if($ct_enable_front_end_registration != 'no') { esc_html_e('Login / Register', 'contempo'); } else { esc_html_e('Login', 'contempo'); } ?></a>
                                </li>
                                <?php if(!empty($submit_listing) && $ct_options['ct_enable_front_end'] == 'yes') { ?>
                                <li class="submit-listing"><a class="btn-outline"
                                        href="<?php echo get_page_link($submit_listing); ?>"><?php esc_html_e('Submit Listing', 'contempo'); ?></a>
                                </li>
                                <?php } ?>
                                <?php } ?>
                            </ul>
        ...
        <!-- Header -->
        <div id="header-wrap"
            <?php if($ct_trans_header == 'yes' && is_front_page() && strpos($url,'search-listings=true') != true) { echo 'class="trans-header"'; } ?>>
            <div class="container">
                <header id="masthead" class="layout-<?php echo esc_html($header_layout); ?>">
                    <?php do_action('inner_header'); ?>
                    <?php
                    ...
                    <div class="logo-wrap col span_3">
                        ...
                        <?php if(!empty($ct_options['ct_logo']['url'])) { ?>
                        <a href="<?php echo home_url(); ?>"><img class="logo right"
                                src="<?php echo esc_url($ct_options['ct_logo']['url']); ?>"
                                <?php if(!empty($ct_logo_highres)) { ?>srcset="<?php echo esc_url($ct_logo_highres); ?> 2x"
                                <?php } ?> alt="<?php bloginfo('name'); ?>" /></a>
                        <?php } else { ?>
                ...
                <header id="masthead" class="layout-<?php echo esc_html($header_layout); ?>">
                    ...
                    <div class="logo-wrap col span_3 first">
                        <a href="<?php echo home_url(); ?>"><img class="logo left"
                                src="<?php echo get_template_directory_uri(); ?>/images/re7-logo.png"
                                srcset="<?php echo get_template_directory_uri(); ?>/images/re7-logo@2x.png 2x"
                                alt="WP Pro Real Estate 7, a WordPress theme by Contempo" /></a>
                    </div>
                    <!-- //Logo -->
